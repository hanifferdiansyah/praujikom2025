            ...
            <div class="col-10 m-auto mt-5">
                <div class="card">
                    <div class="card-header text-center bg-dark bg-gradient">
                        <h3 class="text-white">FORM EDIT DATA BEROBAT</h3>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="proses_edit.php">
                            <div class="mb-3 row">
                                <label for="transaksi" class="col-sm-3 col-form-label">No Transaksi</label>
                                <div class="col-sm-9">
                                    <input type="text" value="<?= $transaksi ?>" readonly name="transaksi"
                                        class="form-control" id="transaksi" placeholder="Masukkan No Transaksi">
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Nama Pasien</label>
                                <div class="col-sm-9">
                                    <select name="pasien" class="form-select" aria-label="Default select example">
                                        ...
                                        foreach ($qry as $row) {
                                            ...
                                            <option <?php echo ($pasien == $row['PasienKlinik_ID']) ? 'selected' : '' ?>
                                                value="<?= $row['PasienKlinik_ID'] ?>"><?= $row['Nama_pasienKlinik'] ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-3 ">
                                    <select class="form-control" name="tgl" id="">
                                        ...
                                        for ($i = 1; $i <= 31; $i++) {
                                            ?>
                                            <option <?php echo ($tgl == $i) ? 'selected' : '' ?> value="<?= $i ?>"><?= $i ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="col-sm-3">
                                    <input type="number" value="<?= $thn ?>" maxlength="4" class="form-control" id="thn"
                                        name="thn" placeholder="Masukkan Tahun Berobat">
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Nama Dokter</label>
                                <div class="col-sm-9">
                                    <select name="dokter" class="form-select" aria-label="Default select example">
                                        <option selected class="placeholder-option" disabled hidden>Pilih Nama Dokter
                                        </option>
                                        <?php
                                        include('../koneksi.php');
                            ...
                            <div class="mb-3 row">
                                <label for="keluhan" class="col-sm-3 col-form-label">Keluhan Pasien</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="keluhan" name="keluhan" rows="3" placeholder="Masukkan alamat"><?=$keluhan?></textarea>
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="administrasi" class="col-sm-3 col-form-label">Biaya Administrasi</label>
                                <div class="col-sm-9">
                                    <input type="text" value="<?=$administrasi?>" class="form-control" id="administrasi" name="administrasi"
