            ...
            <div class="col-10 m-auto mt-5">
                <div class="card">
                    <div class="card-header text-center bg-dark bg-gradient" >
                        <h3 class="text-white">TAMBAH DATA BEROBAT</h3>
                    </div>
                        ...
                        <form method="post" action="proses_form.php">
                            ...
                            <div class="mb-3 row">
                                ...
                                <select name="pasien" class="form-select" aria-label="Default select example">
                                    <option selected class="placeholder-option" disabled hidden>Pilih Nama Pasien</option>
                                    <?php
                                        include('../koneksi.php');
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" maxlength="4" class="form-control" id="thn" name="thn" 
                                        placeholder="Masukkan Tahun Berobat">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <select name="dokter" class="form-select" aria-label="Default select example">
                                    <option selected class="placeholder-option" disabled hidden>Pilih Nama Dokter</option>
                                    <?php
                                        include('../koneksi.php');
