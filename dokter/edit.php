            ...
            <div class="col-10 m-auto mt-5">
                <div class="card">
                    <div class="card-header text-center bg-dark bg-gradient">
                        <h3 class="text-white">FORM EDIT DATA DOKTER</h3>
                    </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama" name="nama"
                                       value="<?=$nama?>" placeholder="Masukkan Nama Lengkap Dokter">
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="exampleInputPassword1" class="col-sm-3 col-form-label">Nama Poli</label>
                                <div class="col-sm-9">
                                <select name="poli" class="form-select" aria-label="Default select example">
                                    <option selected class="placeholder-option" disabled hidden>Pilih Poli</option>
                                    <?php
                                        include('../koneksi.php');
