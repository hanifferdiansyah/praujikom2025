            ...
            <div class="col-10 m-auto mt-5">
                <div class="card">
                    <div class="card-header text-center bg-dark bg-gradient">
                        <h3 class="text-white">FORM EDIT DATA PASIEN</h3>
                    </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama" name="nama"
                                       value="<?=$nama?>" placeholder="Masukkan Nama Lengkap Pasien">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="tgl" name="tgl"
                                      value="<?=$tgl_lahir?>"  placeholder="Masukkan Nama Lengkap Pasien">
                                </div>
                            </div>
